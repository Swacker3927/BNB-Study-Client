    ...
    <template #append>
      <q-btn icon="mdi-calendar" round flat tabindex="-1" dense>
        <q-popup-proxy cover transition-show="scale" transition-hide="scale">
          <q-date v-model="model" mask="YYYY-MM-DD" years-in-month-view :title="popupTitle" :subtitle="$attrs.label">
            <q-btn v-close-popup icon="mdi-close" color="white" flat round
